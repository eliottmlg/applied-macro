...
residual(13) = 1-params(13)+params(13)*y(33)-params(18)*y(34)*(y(34)-(steady_state(14)))+T(18)*(y(67)-(steady_state(14)));
    ...
    residual(15) = ((y(39)*params(28)*T(21)/(params(29)*params(30)*(1+y(52))))^(1/(params(30)-1))) - (y(40));
    residual(16) = (1-y(52)) - (y(51)*params(1)*y(66)/y(31));
    residual(17) = (y(29)+y(23)+y(26)*y(25)+y(8)/y(34)*y(7)+y(50)/y(34)*y(9)+y(27)*params(29)*T(19)+y(39)*y(41)) - (y(49)+y(30)+y(27)*y(33)+y(27)*T(22));
    residual(18) = (y(22)) - (y(24)+y(23));
    residual(19) = (y(41)) - (T(21)*params(28)*(1-y(40)));
    residual(20) = (y(21)) - (y(35)/y(67));
    residual(21) = (y(51)) - (y(50)/y(34));
    residual(22) = (y(50)) - (y(35)-params(35));
    residual(23) = (y(49)) - (y(28)*y(69)*params(11)*y(63)/y(21)-y(27)*T(19)*params(29)*params(41)*y(62));
    residual(24) = (y(35)) - (T(23)*T(27)*y(58));
    residual(25) = (y(42)) - ((steady_state(7))*params(8)*y(54));
    residual(26) = (y(39)) - (params(32)*y(59));
    residual(27) = (y(43)) - (log(y(27)/y(4)));
    residual(28) = (y(44)) - (log(y(22)/y(1)));
    residual(29) = (y(45)) - (log(T(13)));
    residual(30) = (y(46)) - (y(34)-(steady_state(14)));
    residual(31) = (y(47)) - (y(35)-(steady_state(15)));
    residual(32) = (y(48)) - (log(y(30)/y(7)));
