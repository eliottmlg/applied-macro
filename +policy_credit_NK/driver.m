...
options_.order = 1;
var_list_ = {'y';'c_H';'c_E';'i';'pi';'r';'l';'mu';'e'};
...
ee_matx(end-Thorizon+1,idx) = 0.32;
...
ee_matx(end-Thorizon+1,idx) = 0.3;
...
idx = strmatch('eta_t',M_.exo_names,'exact');
ee_matx(end-Thorizon+1,idx) = 0.32;
ee_matx(end-Thorizon+1+4,idx) = 0.32;
ee_matx(end-Thorizon+1+8,idx) = 0.32;
ee_matx(end-Thorizon+1+12,idx) = 0.32;
ee_matx(end-Thorizon+1+16,idx) = 0.32;
ee_matx(end-Thorizon+1+20,idx) = 0.32;
ee_matx(end-Thorizon+1+24,idx) = 0.32;
y_baseline           = simult_(M_,options_,oo_.dr.ys,oo_.dr,ee_matx,options_.order);
Mlarge  = M_;
oolarge = oo_;
Mlarge.params(strcmp('mk',M_.param_names)) = 0.9;
...
save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'policy_credit_NK_results.mat'], 'options_mom_', '-append');
end
