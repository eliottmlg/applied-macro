...
T(4) = params(1)*y(60)/y(27);
T(5) = params(14)*T(4)*y(65)*y(63);
T(6) = 1-y(59)/y(25);
T(7) = T(5)*T(6);
T(8) = (y(59)/y(25))^2;
T(9) = y(5)^params(4);
T(10) = y(50)*params(9)*T(9);
T(11) = y(21)^(1-params(4));
T(12) = y(25)/y(6);
T(13) = 1-T(2)*(T(12)-1)^2;
T(14) = (y(19)-params(12)*y(2))^(-params(5));
T(15) = y(58)*y(60)*params(1)*params(18)/y(27)/y(23);
T(16) = T(15)*y(61);
...
T(21) = y(8)^params(15);
T(22) = y(30)/(steady_state(14));
T(23) = (steady_state(15))*T(22)^params(17);
T(24) = y(23)/(steady_state(7));
T(25) = T(24)^params(16);
T(26) = T(23)*T(25);
