...
=======
			sig theta1 theta2 varphi  tau0 y0;
>>>>>>> 9b33eab1212ab750e77b816dff3daff8008c73fa:Practice/credit_NK.mod
...
sigmaO = 8.9300;    % elasticity ordinary bonds
chi_s   = 5;       % weight of SLBs
chi_o   = 0.05;    % weight of ordinary bonds
BDratio = 0.05;     % Bonds (SLB + ordinary) over debt ratio for entrepreneurs;
