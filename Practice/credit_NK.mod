...
% Lists endogenous variables (solved by the model)
var rr c c_E c_H h w y k i l lb_E phi_E mc pi r lb_H q varrho tau mu e g;
...
% List of parameters: discount factors, elasticities, adjustment costs, etc.
