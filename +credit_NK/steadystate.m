...
% Steady state generated by Dynare preprocessor
    ...
    ys_(7)=params(34);
    ys_(19)=params(33);
    ys_(20)=(ys_(19)*params(29)*ys_(7)^(1-params(32))/(params(31)*params(30)))^(1/(params(31)-1));
    ys_(21)=ys_(7)^(1-params(32))*params(29)*(1-ys_(20));
    ys_(22)=ys_(7)*params(8);
    ys_(14)=params(19);
    ys_(1)=1/params(2);
    ys_(15)=ys_(14)*ys_(1);
    ys_(13)=(params(13)-1)/params(13);
    ys_(18)=ys_(13)-params(30)*ys_(20)^params(31)-(1-ys_(20))*params(29)*ys_(19)*(1-params(32))*ys_(7)^(-params(32));
    ...
    ys_(3)=(-ys_(9))-ys_(5)*ys_(6)-ys_(7)*params(30)*ys_(20)^params(31)-ys_(19)*ys_(21)+ys_(7)*ys_(13)+ys_(7)*(1-ys_(13))+ys_(10)*(1-ys_(1));
    ys_(2)=ys_(7)*(1-params(8))-ys_(9)-ys_(7)*params(30)*ys_(20)^params(31);
    ys_(4)=ys_(2)-ys_(3);
