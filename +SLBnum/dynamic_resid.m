...
residual(13) = 1-params(13)+params(13)*y(33)-params(18)*y(34)*(y(34)-(steady_state(14)))+T(18)*(y(67)-(steady_state(14)));
    ...
    residual(17) = (y(29)+y(23)+y(26)*y(25)+y(8)/y(34)*y(7)+y(50)/y(34)*y(9)+y(27)*params(29)*T(19)+y(39)*y(41)) - (y(49)+y(30)+y(27)*y(33)+y(27)*(1-y(33)-params(18)/2*T(22)));
    residual(18) = (y(27)) - (y(27)*params(29)*T(19)+y(29)+y(22)+y(42)+T(22)*y(27)*params(18)/2);
