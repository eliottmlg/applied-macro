...
% Steady state generated by Dynare preprocessor
    ...
    ys_(20)=((ys_(19)*params(28)*ys_(7)^(1-params(31))+ys_(32)*params(41))/(params(30)*params(29)))^(1/(params(30)-1));
    ...
    ys_(8)=ys_(7)*ys_(18)*(1-ys_(12))*params(4)/(ys_(1)-(1-ys_(12))*(1-params(3))-ys_(12)*params(11)-ys_(32)*params(43)/ys_(30));
    ...
    ys_(3)=ys_(7)+ys_(10)*(1-ys_(1))+ys_(29)*(1-ys_(30)/ys_(14))-ys_(9)-ys_(5)*ys_(6)-ys_(7)*params(29)*ys_(20)^params(30)-ys_(19)*ys_(21);
