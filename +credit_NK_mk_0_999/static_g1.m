...
if T_flag
    T = credit_NK_mk_0_999.static_g1_tt(T, y, x, params);
end
g1 = zeros(39, 39);
...
g1(11,5)=(-((-(y(7)*(1-params(4))*y(18)*(1+y(39)*params(10)*y(12))))/(y(5)*(1+y(39)*params(10)*y(12))*y(5)*(1+y(39)*params(10)*y(12)))));
g1(11,6)=1;
g1(11,7)=(-((1-params(4))*y(18)/(y(5)*(1+y(39)*params(10)*y(12)))));
g1(11,12)=(-((-(y(7)*(1-params(4))*y(18)*y(5)*y(39)*params(10)))/(y(5)*(1+y(39)*params(10)*y(12))*y(5)*(1+y(39)*params(10)*y(12)))));
g1(11,18)=(-(y(7)*(1-params(4))/(y(5)*(1+y(39)*params(10)*y(12)))));
g1(11,39)=(-((-(y(7)*(1-params(4))*y(18)*y(5)*params(10)*y(12)))/(y(5)*(1+y(39)*params(10)*y(12))*y(5)*(1+y(39)*params(10)*y(12)))));
g1(12,13)=params(13);
g1(12,14)=(y(14)-(y(14)))*params(1)*params(18)-params(18)*(y(14)-(y(14)));
g1(13,7)=y(19)*(1-params(33))*params(30)*(1-y(20))*getPowerDeriv(y(7),(-params(33)),1);
g1(13,13)=(-1);
g1(13,18)=1;
g1(13,19)=T(7)*(1-y(20))*(1-params(33))*params(30);
g1(13,20)=(-((-T(19))-T(7)*(-(y(19)*(1-params(33))*params(30)))));
g1(14,7)=y(19)*params(30)*T(16)/(params(31)*params(32))*T(17);
g1(14,19)=T(17)*params(30)*T(8)/(params(31)*params(32));
g1(14,20)=(-1);
g1(15,3)=1;
g1(15,5)=y(6);
g1(15,6)=y(5);
...
g1(17,3)=(-1);
g1(17,4)=(-1);
g1(18,7)=(-(y(38)*params(30)*(1-y(20))*T(16)));
g1(18,20)=(-(y(38)*T(8)*(-params(30))));
g1(18,21)=1;
g1(18,38)=(-(T(8)*params(30)*(1-y(20))));
g1(19,1)=1;
